...
// This grabs the Duplicates buy name and renames
  ...
  layerOne.name = "25% " + decodeURI(theDoc.name).toString().replace(/\..+$/, '') + "_@1x.png";
  var layerOne = activeDocument.artLayers.getByName(" 5");
  layerOne.name = "38% " + decodeURI(theDoc.name).toString().replace(/\..+$/, '') + "_@1.5x.png";
  var layerTwo = activeDocument.artLayers.getByName(" 2 copy");
  layerTwo.name = "50% " + decodeURI(theDoc.name).toString().replace(/\..+$/, '') + "_@2x.png";
  var layerThree = activeDocument.artLayers.getByName(" 3 copy");
  layerThree.name = "75% " + decodeURI(theDoc.name).toString().replace(/\..+$/, '') + "_@3x.png";
  var layerFour = activeDocument.artLayers.getByName(" 4 copy");
  layerFour.name = decodeURI(theDoc.name).toString().replace(/\..+$/, '') + " _@4x.png";
